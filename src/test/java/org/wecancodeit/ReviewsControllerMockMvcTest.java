...
public class ReviewsControllerMockMvcTest {
	...
	@Test
	public void shouldGetSatusofOkWhenNavigatingToAllReviews() throws Exception {
		this.mockMvc.perform(get("/show-reviews")).andExpect(status(). isOk())
		.andExpect(view().name("reviews-template"));
	}
	
	@Test
	public void shouldGetSatusofOkWhenNavigatingToReviewOnePage() throws Exception {
	...
	public void shouldReturnNotFoundForBadRequest() throws Exception {
		...
		this.mockMvc.perform(get("/show-single-review?id=8"))
